...
standard_data = [
    ...
    '{"particulars": {"description": "EXPIRE 2100s.2 1 The Street, Some Town", "counties": ["Dorset"], "district": "South Hams"}, "class_of_charge": "C1", "applicant": {"address": "Land Registry Information Systems, 2 William Prance Road, Plymouth", "key_number": "244095", "name": "P334 Team", "reference": "reference 11"}, "parties": [{"type": "Estate Owner", "names": [{"type": "Other", "other": "Bob Smith And Bros Associated"}]}]}',
     '{"applicant": {"name": "Waste of space", "address": "12 Bay View, My Town", "key_number": "1234567", "reference": " "}, "parties":[{"names": [{"type": "Private Individual", "private": {"forenames": ["Robert"], "surname": "Jones" }}, {"type": "Private Individual", "private": {"forenames": ["Bob", "Alan"], "surname": "Jones"}}], "trading_name": " ", "addresses": [{"county": "Devon", "address_lines": ["12 bay view", "Plymouth"], "postcode": "PL3 3PL", "type": "Residence", "address_string": "12 bay view Plymouth Devon PL3 3PL"}, {"county": "Dorset", "address_lines": ["3 apple Street", "plymouth", "a third line", "a fourth line", "a five line"], "postcode": "postcode", "type": "Residence", "address_string": "3 apple Street plymouth a third line a fourth line a five line Cornwall postcode"}], "occupation": "", "type": "Debtor", "residence_withheld": false, "case_reference": "Plymouth County Court 233 of 2016", "legal_body": "Plymouth County Court", "legal_body_ref_no": "233", "legal_body_ref_year": 2016, "counties": ["Devon", "Dorset"]}], "class_of_charge": "WOB"}'
]
